...
"""
This program checks the xml files for various issues related to xml syntax and schema,
and/or in relation to the CF standard.

The following external libraries need to be installed:
lxml      : https://lxml.de/
cfunits   : https://cf-units.readthedocs.io/en/latest/
cf-units  : https://ncas-cms.github.io/cfunits/


The xml file is read in binary mode because the lxml package cannot handle unicode.
"""
...
PATH0 = "../"
BASE_PATH = PATH0 + "Data/cf-standard-names/"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        prog="list_errors",
        description=("\nList (most) XML errors and/or CF errors in Standard Name Table xml files.")
    )
